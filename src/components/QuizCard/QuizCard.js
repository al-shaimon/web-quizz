...
const QuizCard = ({
    ...
    return ( <
        ...
        div className = "p-3" >
        <
        h1 className = 'lg:text-3xl text-bold my-4 ' > Topics: {
            name
        } < /h1> <
        ...
        p className = "text-sm" >
        <
        span className = "text-base font-semibold" > See why administrators love Testing Quiz Logo
        for their teachers and students.! < /span> <
        /p> <
        div className = 'flex justify-between pt-4' >
        <
        h2 className = 'text-xl' > Total Quizs: {
            total
        } < /h2> <
        Link to = {
            `/quiz${id}`
